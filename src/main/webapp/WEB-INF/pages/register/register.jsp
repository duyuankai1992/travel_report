...
<head>
    <meta charset="utf-8">
    <title>手机号注册 - 游侠客旅游网-旅行者的社交网络</title>
    <meta name="keywords"
...
<section class="g-body">
    ...
    <form name="regFormStep1" id="regFormStep1" action="http://www.youxiake.com/register/mobilecheck" class="u-form"
          method="post">
        <div class="u-form-item foreign-tel">
            <label for="logonId" class="u-label">手机号码：</label>
            <span class="tel-forenum">0086</span>
            <input name="mobile" id="logonId" class="u-input" type="text" autocomplete="off"
                   placeholder="请输入手机号码" tabindex="1">
            <div class="u-form-explain"></div>
        </div>
        <div class="u-form-item">
            <div class="attachment">没有手机？<a href="http://www.youxiake.com/reg?email=1">用邮箱注册</a></div>
        </div>
        <div class="u-form-item">
        ...
        <div class="u-form-item">
            ...
            <label>城市：</label>
            <select style="height: 30px;" name="city" id="city"></select>
        </div>

        <div class="u-form-item">
            <label for="password" class="u-label">登录密码：</label>
            <input name="password" id="password" class="u-input u-ipwd" type="password" maxlength="20"
                   plugin="passwordStrength" oncontextmenu="return false" onpaste="return false"
                   oncopy="return false" oncut="return false" autocomplete="off" tabindex="4">
            <div class="u-form-explain"></div>
            <!--S 密码强度 -->
        ...
        <div class="u-form-item">
            ...
            <input name="confirmPwd" id="confirmPwd" class="u-input" type="password"
                   ...
                   oncut="return false" autocomplete="off" tabindex="5">
            <div class="u-form-explain"></div>
        </div>
        <div class="u-form-item">
        ...
        <div class="u-form-item foreign-act">
            <label for="authcode" class="u-label">短信码：</label>

            <input name="authcode" id="authcode" class="u-input u-authcode" type="text"
                   autocomplete="off" style="float:left;margin-right:10px;"
                   maxlength="6" placeholder="短信码" tabindex="6">
            <div class="m-act">
                <a class="m-act-btn" id="activation" href="javascript:;"><span>免费获取短信验证码</span></a>
                <a class="m-act-btn-disable" id="activation-disable" href="javascript:;"
                   style="display:none"><span><em>0</em>秒后重新获取短信</span></a>
            </div>
            <div class="u-form-explain" id="activation-exolain"></div>
        </div>
        <div class="u-form-item">
